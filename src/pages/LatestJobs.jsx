        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-4">
            <button
              ...
              className="flex items-center gap-4 text-gray-400 hover:text-indigo-400 transition-colors"
            >
              ...
              return (
                ...
                >
                  ...
                  <a
                    ...
                    className="mt-2 w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 bg-indigo-600 hover:bg-indigo-500 rounded-lg text-white font-medium transition transform hover:scale-[1.02] active:scale-[0.98]"
                  >
