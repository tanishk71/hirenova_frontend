...
export default function CourseDetails() {
  ...
  if (!course) return (
    <div className="text-center py-12 text-gray-400">Course not found</div>
  );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-gray-800/40 backdrop-blur-md border border-gray-700/50 rounded-xl p-8 text-center">
          ...
          <a
            ...
            className="inline-block px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 rounded-lg font-semibold transition"
          >
